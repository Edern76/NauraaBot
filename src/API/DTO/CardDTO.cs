...
public class CardDTO
{
    ...
    public IDNameObject CardType { get; set; }
    [JsonProperty("cardSet")]
    public IDNameObject CardSet { get; set; }
    [JsonProperty("rarity")]
    public IDNameObject Rarity { get; set; }
    [JsonProperty("imagePath")]
    public string ImagePath { get; set; }
    [JsonProperty("updatedAt")]
    public string UpdatedAt { get; set; } // Note to self, don't forget to convert to TimeDate when creating the actual DB object from this DTO
    [JsonProperty("mainFaction")]
    public IDNameObject MainFaction { get; set; }
    [JsonProperty("name")]
...
public class ElementsDTO
{
    ...
    public int? PermanentsNumber { get; set; }
