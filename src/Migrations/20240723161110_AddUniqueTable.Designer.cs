...
namespace NauraaBot.Migrations
{
    ...
    [Migration("20240723161110_AddUniqueTable")]
    partial class AddUniqueTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NauraaBot.Unique", b =>
                {
                    b.HasBaseType("NauraaBot.Database.Models.Card");

                    b.ToTable("Unique", (string)null);
                });
            ...
            modelBuilder.Entity("NauraaBot.Database.Models.Card", b =>
                {
                    ...
                    b.OwnsOne("NauraaBot.Core.Utils.LocalizedString", "DiscardEffect", b1 =>
                        {
                            b1.Property<string>("CardID")
                                .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NauraaBot.Unique", b =>
                {
                    b.HasOne("NauraaBot.Database.Models.Card", null)
                        .WithOne()
                        .HasForeignKey("NauraaBot.Unique", "ID")
